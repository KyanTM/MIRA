...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'contracts',
        loadComponent: () => import('./features/records/record-page').then((m) => m.RecordPage),
        data: { kind: 'contracts', mode: 'list' },
        title: 'Contracten | MIRA',
      },
      {
        path: 'contracts/new',
        loadComponent: () => import('./features/records/record-page').then((m) => m.RecordPage),
        data: { kind: 'contracts', mode: 'new' },
        title: 'Contracten | MIRA',
      },
      {
        path: 'contracts/:id/edit',
        loadComponent: () => import('./features/records/record-page').then((m) => m.RecordPage),
        data: { kind: 'contracts', mode: 'edit' },
        title: 'Contracten | MIRA',
      },
      {
        path: 'contracts/:id',
        loadComponent: () => import('./features/records/record-page').then((m) => m.RecordPage),
        data: { kind: 'contracts', mode: 'detail' },
        title: 'Contracten | MIRA',
      },
      {
        path: 'warranties',
        loadComponent: () => import('./features/records/record-page').then((m) => m.RecordPage),
        data: { kind: 'warranties', mode: 'list' },
        title: 'Garanties | MIRA',
      },
      {
        path: 'warranties/new',
        loadComponent: () => import('./features/records/record-page').then((m) => m.RecordPage),
        data: { kind: 'warranties', mode: 'new' },
        title: 'Garanties | MIRA',
      },
      {
        path: 'warranties/:id/edit',
        loadComponent: () => import('./features/records/record-page').then((m) => m.RecordPage),
        data: { kind: 'warranties', mode: 'edit' },
        title: 'Garanties | MIRA',
      },
      {
        path: 'warranties/:id',
        loadComponent: () => import('./features/records/record-page').then((m) => m.RecordPage),
        data: { kind: 'warranties', mode: 'detail' },
        title: 'Garanties | MIRA',
      },
      {
        path: 'documents',
        loadComponent: () => import('./features/records/record-page').then((m) => m.RecordPage),
        data: { kind: 'documents', mode: 'list' },
        title: 'Documenten | MIRA',
      },
      {
        path: 'documents/new',
        loadComponent: () => import('./features/records/record-page').then((m) => m.RecordPage),
        data: { kind: 'documents', mode: 'new' },
        title: 'Documenten | MIRA',
      },
      {
        path: 'documents/:id/edit',
        loadComponent: () => import('./features/records/record-page').then((m) => m.RecordPage),
        data: { kind: 'documents', mode: 'edit' },
        title: 'Documenten | MIRA',
      },
      {
        path: 'documents/:id',
        loadComponent: () => import('./features/records/record-page').then((m) => m.RecordPage),
        data: { kind: 'documents', mode: 'detail' },
        title: 'Documenten | MIRA',
      },
      {
        path: '',
