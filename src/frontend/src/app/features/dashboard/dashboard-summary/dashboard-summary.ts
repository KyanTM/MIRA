...
export class DashboardSummary {
  ...
  readonly metrics = computed<SummaryMetric[]>(() => {
    ...
    return [
      ...
      { label: 'Documenten', value: counts.documents, link: '/documents' },
      { label: 'Garanties', value: counts.warranties, link: '/warranties' },
      { label: 'Contracten', value: counts.contracts, link: '/contracts' },
